...
struct IMMUTABLEINDEXERSEARCHAPI_API HttpRetryManager
	: public FManager
...
struct IMMUTABLEINDEXERSEARCHAPI_API HttpRetryParams
{
	HttpRetryParams(
...
class IMMUTABLEINDEXERSEARCHAPI_API Model
{
public:
	virtual ~Model() {}
...
class IMMUTABLEINDEXERSEARCHAPI_API Request
{
public:
	virtual ~Request() {}
...
class IMMUTABLEINDEXERSEARCHAPI_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
