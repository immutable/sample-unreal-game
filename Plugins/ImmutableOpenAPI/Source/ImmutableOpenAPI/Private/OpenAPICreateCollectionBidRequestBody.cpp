...
void OpenAPICreateCollectionBidRequestBody::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateCollectionBidRequestBody::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
