...
void OpenAPICreateListingRequestBody::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateListingRequestBody::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
