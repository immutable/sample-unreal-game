...
void OpenAPIListCollectionBidsResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListCollectionBidsResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
