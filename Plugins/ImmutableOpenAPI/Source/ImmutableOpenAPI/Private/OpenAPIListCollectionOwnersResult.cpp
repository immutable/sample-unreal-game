...
void OpenAPIListCollectionOwnersResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIListCollectionOwnersResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
