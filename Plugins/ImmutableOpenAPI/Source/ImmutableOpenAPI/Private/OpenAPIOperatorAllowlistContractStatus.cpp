...
#include "OpenAPIOperatorAllowlistContractStatus.h"
...
void OpenAPIOperatorAllowlistContractStatus::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOperatorAllowlistContractStatus::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
