...
inline FString ToString(const OpenAPIOrder::TypeEnum& Value)
{
	...
	case OpenAPIOrder::TypeEnum::Listing:
		return TEXT("LISTING");
	case OpenAPIOrder::TypeEnum::Bid:
		return TEXT("BID");
	case OpenAPIOrder::TypeEnum::CollectionBid:
		return TEXT("COLLECTION_BID");
	}

	UE_LOG(LogImmutableOpenAPI, Error, TEXT("Invalid OpenAPIOrder::TypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}
...
inline bool FromString(const FString& EnumAsString, OpenAPIOrder::TypeEnum& Value)
{
	static TMap<FString, OpenAPIOrder::TypeEnum> StringToEnum = { 
		...
		{ TEXT("BID"), OpenAPIOrder::TypeEnum::Bid },
		{ TEXT("COLLECTION_BID"), OpenAPIOrder::TypeEnum::CollectionBid }, };
