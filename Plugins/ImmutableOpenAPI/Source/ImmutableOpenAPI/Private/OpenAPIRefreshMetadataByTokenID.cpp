...
void OpenAPIRefreshMetadataByTokenID::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRefreshMetadataByTokenID::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
