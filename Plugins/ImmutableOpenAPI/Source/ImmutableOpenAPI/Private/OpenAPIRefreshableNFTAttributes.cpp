...
#include "OpenAPIRefreshableNFTAttributes.h"
...
void OpenAPIRefreshableNFTAttributes::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIRefreshableNFTAttributes::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
