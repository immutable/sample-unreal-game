...
#include "OpenAPIVerificationRequest.h"
...
void OpenAPIVerificationRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIVerificationRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
