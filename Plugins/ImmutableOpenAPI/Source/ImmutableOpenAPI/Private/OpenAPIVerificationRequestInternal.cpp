...
#include "OpenAPIVerificationRequestInternal.h"
...
void OpenAPIVerificationRequestInternal::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIVerificationRequestInternal::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
