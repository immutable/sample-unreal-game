...
struct IMMUTABLEOPENAPI_API HttpRetryManager
	: public FManager
...
struct IMMUTABLEOPENAPI_API HttpRetryParams
{
	HttpRetryParams(
...
class IMMUTABLEOPENAPI_API Model
{
public:
	virtual ~Model() {}
...
class IMMUTABLEOPENAPI_API Request
{
public:
	virtual ~Request() {}
...
class IMMUTABLEOPENAPI_API Response
{
public:
	virtual ~Response() {}
	virtual bool FromJson(const TSharedPtr<FJsonValue>& JsonValue) = 0;
