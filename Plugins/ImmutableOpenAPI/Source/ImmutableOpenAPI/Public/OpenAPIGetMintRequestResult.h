...
/*
 * OpenAPIGetMintRequestResult
 *
 * 
 */
class IMMUTABLEOPENAPI_API OpenAPIGetMintRequestResult : public Model
{
public:
    virtual ~OpenAPIGetMintRequestResult() {}
	...
	FDateTime UpdatedAt;
	TOptional<OpenAPIMintRequestErrorMessage> Error;
	OpenAPIMintRequestStatus Status;
};
