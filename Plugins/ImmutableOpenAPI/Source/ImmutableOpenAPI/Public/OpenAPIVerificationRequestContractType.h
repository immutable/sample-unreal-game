...
/*
 * OpenAPIVerificationRequestContractType
 *
 * The contract type associated with the given request
 */
class IMMUTABLEOPENAPI_API OpenAPIVerificationRequestContractType : public Model
{
public:
    virtual ~OpenAPIVerificationRequestContractType() {}
