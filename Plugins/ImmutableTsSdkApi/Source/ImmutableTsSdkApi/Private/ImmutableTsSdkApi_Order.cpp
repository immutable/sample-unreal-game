...
inline FString ToString(const ImmutableTsSdkApi_Order::TypeEnum& Value)
{
	switch (Value)
	{
	case ImmutableTsSdkApi_Order::TypeEnum::Listing:
		return TEXT("LISTING");
	}

	UE_LOG(LogImmutableTsSdkApi, Error, TEXT("Invalid ImmutableTsSdkApi_Order::TypeEnum Value (%d)"), (int)Value);
	return TEXT("");
}

FString ImmutableTsSdkApi_Order::EnumToString(const ImmutableTsSdkApi_Order::TypeEnum& EnumValue)
{
	return ToString(EnumValue);
}

inline bool FromString(const FString& EnumAsString, ImmutableTsSdkApi_Order::TypeEnum& Value)
{
	static TMap<FString, ImmutableTsSdkApi_Order::TypeEnum> StringToEnum = { 
		{ TEXT("LISTING"), ImmutableTsSdkApi_Order::TypeEnum::Listing }, };
...
bool ImmutableTsSdkApi_Order::EnumFromString(const FString& EnumAsString, ImmutableTsSdkApi_Order::TypeEnum& EnumValue)
{
	return FromString(EnumAsString, EnumValue);
}

inline void WriteJsonValue(JsonWriter& Writer, const ImmutableTsSdkApi_Order::TypeEnum& Value)
{
	WriteJsonValue(Writer, ToString(Value));
}

inline bool TryGetJsonValue(const TSharedPtr<FJsonValue>& JsonValue, ImmutableTsSdkApi_Order::TypeEnum& Value)
{
	FString TmpValue;
...
void ImmutableTsSdkApi_Order::WriteJson(JsonWriter& Writer) const
{
...
bool ImmutableTsSdkApi_Order::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
