...
void ImmutableTsSdkApi_OrderComponents::WriteJson(JsonWriter& Writer) const
{
...
bool ImmutableTsSdkApi_OrderComponents::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
