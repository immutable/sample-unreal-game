...
void ImmutableTsSdkApi_TransactionActionPopulatedTransactions::WriteJson(JsonWriter& Writer) const
{
...
bool ImmutableTsSdkApi_TransactionActionPopulatedTransactions::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
