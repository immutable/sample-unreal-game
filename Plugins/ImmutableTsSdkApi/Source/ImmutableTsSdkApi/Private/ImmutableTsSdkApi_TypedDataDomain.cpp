...
void ImmutableTsSdkApi_TypedDataDomain::WriteJson(JsonWriter& Writer) const
{
...
bool ImmutableTsSdkApi_TypedDataDomain::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
