...
void ImmutableTsSdkApi_V1TsSdkOrderbookCancelOrdersPostRequest::WriteJson(JsonWriter& Writer) const
{
...
bool ImmutableTsSdkApi_V1TsSdkOrderbookCancelOrdersPostRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
