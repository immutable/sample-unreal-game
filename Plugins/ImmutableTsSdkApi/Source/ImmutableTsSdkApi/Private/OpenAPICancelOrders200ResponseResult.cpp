...
void OpenAPICancelOrders200ResponseResult::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICancelOrders200ResponseResult::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
