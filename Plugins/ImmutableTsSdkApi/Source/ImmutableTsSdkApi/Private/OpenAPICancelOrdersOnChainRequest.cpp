...
void OpenAPICancelOrdersOnChainRequest::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICancelOrdersOnChainRequest::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
