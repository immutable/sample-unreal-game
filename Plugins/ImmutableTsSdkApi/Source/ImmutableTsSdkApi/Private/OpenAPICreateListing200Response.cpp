...
void OpenAPICreateListing200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreateListing200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
