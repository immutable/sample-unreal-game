...
void OpenAPIFulfillOrder200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIFulfillOrder200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
