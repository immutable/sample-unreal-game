...
void OpenAPIOrderComponentsConsiderationInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOrderComponentsConsiderationInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
