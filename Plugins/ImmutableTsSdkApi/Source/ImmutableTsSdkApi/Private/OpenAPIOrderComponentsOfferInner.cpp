...
void OpenAPIOrderComponentsOfferInner::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIOrderComponentsOfferInner::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
