...
void OpenAPIPrepareOrderCancellations200Response::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIPrepareOrderCancellations200Response::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
