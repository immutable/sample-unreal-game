...
void OpenAPITransactionActionPopulatedTransactions::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPITransactionActionPopulatedTransactions::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
