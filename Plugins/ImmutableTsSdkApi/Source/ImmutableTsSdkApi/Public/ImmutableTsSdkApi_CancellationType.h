...
/*
 * ImmutableTsSdkApi_CancellationType
 *
 * Whether the cancellation was done on-chain or off-chain or as a result of an underfunded account
 */
class IMMUTABLETSSDKAPI_API ImmutableTsSdkApi_CancellationType : public Model
{
public:
    virtual ~ImmutableTsSdkApi_CancellationType() {}
