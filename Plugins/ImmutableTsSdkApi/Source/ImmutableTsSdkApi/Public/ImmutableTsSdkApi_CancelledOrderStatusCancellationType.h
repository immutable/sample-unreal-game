...
/*
 * ImmutableTsSdkApi_CancelledOrderStatusCancellationType
 *
 * Whether the cancellation was done on-chain or off-chain or as a result of an underfunded account
 */
class IMMUTABLETSSDKAPI_API ImmutableTsSdkApi_CancelledOrderStatusCancellationType : public Model
{
public:
    virtual ~ImmutableTsSdkApi_CancelledOrderStatusCancellationType() {}
