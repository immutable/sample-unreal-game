...
/*
 * ImmutableTsSdkApi_OrderStatusOneOf2
 *
 * 
 */
class IMMUTABLETSSDKAPI_API ImmutableTsSdkApi_OrderStatusOneOf2 : public Model
{
public:
    virtual ~ImmutableTsSdkApi_OrderStatusOneOf2() {}
