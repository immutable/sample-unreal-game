...
/*
 * ImmutableTsSdkApi_OrderStatusOneOf4
 *
 * 
 */
class IMMUTABLETSSDKAPI_API ImmutableTsSdkApi_OrderStatusOneOf4 : public Model
{
public:
    virtual ~ImmutableTsSdkApi_OrderStatusOneOf4() {}
