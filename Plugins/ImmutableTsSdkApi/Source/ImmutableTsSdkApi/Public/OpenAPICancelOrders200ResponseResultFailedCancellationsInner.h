...
/*
 * OpenAPICancelOrders200ResponseResultFailedCancellationsInner
 *
 * 
 */
class IMMUTABLETSSDKAPI_API OpenAPICancelOrders200ResponseResultFailedCancellationsInner : public Model
{
public:
    virtual ~OpenAPICancelOrders200ResponseResultFailedCancellationsInner() {}
