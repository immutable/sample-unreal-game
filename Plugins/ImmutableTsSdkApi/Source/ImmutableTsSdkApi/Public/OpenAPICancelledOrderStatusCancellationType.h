...
/*
 * OpenAPICancelledOrderStatusCancellationType
 *
 * Whether the cancellation was done on-chain or off-chain or as a result of an underfunded account
 */
class IMMUTABLETSSDKAPI_API OpenAPICancelledOrderStatusCancellationType : public Model
{
public:
    virtual ~OpenAPICancelledOrderStatusCancellationType() {}
